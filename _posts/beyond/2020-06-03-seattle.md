...
<div id="places">
    ...
    <div class="flex-container">
        <div class="flex-item-3">
            <img src="/assets/images/beyond/seattle/panorama.JPG" class="image">
        </div>
        <div class="flex-item-3">
            <img src="/assets/images/beyond/seattle/otherfbview.JPG" class="image">
        </div>
        <div class="flex-item-3">
            <img src="/assets/images/beyond/seattle/couch.JPG" class="image">
        </div>
    </div>  
    <p>Just wow, right? 😍</p>
