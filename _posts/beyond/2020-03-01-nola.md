...
<div id="foods">
    ...
    <div class="flex-container">
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/bonemarrowfullimage.JPG" class="image">
            <div class="flexoverlay">
                Bone Marrow Dish
            </div>
        </div>
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/bluecrabnoodles.JPG" class="image">
            <div class="flexoverlay">
    ...
    <div class="flex-container">
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/dbsteak.JPG" class="image">
            <div class="flexoverlay">
                Prime Cowboy Ribeye
            </div>
        </div>
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/cornbrulee.JPG" class="image">
            <div class="flexoverlay">
                Corn Brûlée
            </div>
        </div>
    ...
    <div class="singleimagecontainer">
        <img src="/assets/images/beyond/nola/bbqshrimpgrits.JPG" class="image">
    ...
    <div class="singleimagecontainer">
        <img src="/assets/images/beyond/nola/cafedumonde.JPG" class="image">
        <div class="singleimageoverlay">
            Classic Beignets
        </div>
    </div>
    ...
    <div class="singleimagecontainer">
        <img src="/assets/images/beyond/nola/willajean.JPG" class="image">
        <div class="singleimageoverlay">
            Cookies + Milk
        </div>
    </div>
...
<div id="places">
    ...
    <div class="flex-container">
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/nolarooftop.JPG" class="image">
        </div>
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/nolastview.JPG" class="image">
        </div>
    </div>
    <p>
    ...
    <div class="flex-container">
        <div class="flex-item-3">
            <img src="/assets/images/beyond/nola/gardendistrict.JPG" class="image">
        </div>
        <div class="flex-item-3">
            <img src="/assets/images/beyond/nola/gardendistrict2.JPG" class="image">
        </div>
        <div class="flex-item-3">
            <img src="/assets/images/beyond/nola/gardendistrict3.JPG" class="image">
        </div>
    </div>    
    <p>
    ...
    <div class="flex-container">
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/stlouiscathedral.JPG" class="image">
        </div>
        <div class="flex-item">
            <img src="/assets/images/beyond/nola/nolaxmas.JPG" class="image">
        </div>
    </div>    
    <p>
